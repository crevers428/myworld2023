...
class WcaOauth {
    ...
    protected function curlJson($url, $postParams = null, $headers = null)
    {
        ...
        // dirty trick because I'm unable to update the root cert in an old computer of mine
        if ($_SERVER["HTTP_HOST"]=="localhost") curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, FALSE);
    ...
    */
    public function getUser()
    {
        ...
        //die(json_encode($this->curlJson(self::USER_URI, null, $headers)));
